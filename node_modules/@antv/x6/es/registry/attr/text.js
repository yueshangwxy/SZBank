...
export const text = {
    ...
    set(text, { view, elem, attrs }) {
        ...
        const textAttrs = ObjectExt.pick(attrs, 'lineHeight', 'annotations', 'textPath', 'x', 'textVerticalAnchor', 'eol', 'displayEmpty', 'fontSize');
        textAttrs.fontSize = attrs['font-size'] || attrs['fontSize'];
        const fontSize = textAttrs.fontSize;
            ...
            if (textPath != null && typeof textPath === 'object') {
                ...
                if (typeof selector === 'string') {
                    ...
                    if (pathNode instanceof SVGPathElement) {
                        ...
                        textAttrs.textPath = Object.assign({ 'xlink:href': `#${pathNode.id}` }, textPath);
                    }
                }
            }
            Dom.text(elem, `${text}`, textAttrs);
