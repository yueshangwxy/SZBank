...
const svgContent = '<path id="svg-path" d="M10 10"/>' +
    ...
    '</body>' +
    '</foreignObject>';
createVector('svg', { id: 'svg-container' }, createVectors(svgContent)).appendTo(wrap);
    ...
    describe('elem', () => {
        ...
        describe('#isSVGGraphicsElement', () => {
            ...
            it('should return false when the given element is not a SVGGraphicsElement', () => {
                ...
                expect(isSVGGraphicsElement(createVector('linearGradient').node)).toBe(false);
            });
        });
        describe('#index', () => {
        ...
        describe('#tagName', () => {
            it('should return the correct tagName with lowercase', () => {
                ...
                expect(createVector(svgLinearGradient).tagName()).toEqual('lineargradient');
            });
        ...
        describe('#findParentByClass', () => {
            ...
            it('should stopped early', () => {
                const found1 = createVector(svgGroup3).findParentByClass('group-1', svgGroup2);
                expect(found1 == null).toBe(true);
                const found2 = createVector(svgGroup3).findParentByClass('group-1', svgCircle);
        ...
        describe('#contains', () => {
            it('...', () => {
                ...
                expect(createVector(svgGroup1).contains(document)).toBe(false);
            });
        });
        describe('#empty', () => {
        ...
        describe('#append', () => {
            const group = createVector(createElement('g'));
