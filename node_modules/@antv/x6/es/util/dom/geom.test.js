...
describe('Dom', () => {
    describe('geom', () => {
        const { svgContainer, svgGroup, svgGroup1, svgCircle, svgLinearGradient, svgEllipse, svgPolygon, svgRectangle, svgPath, foreignDiv, } = setupTest();
        ...
        describe('#bbox', () => {
            it('should return a rectangle instance', () => {
                ...
                expect(createVector(svgCircle).bbox(true, svgGroup1)).toBeInstanceOf(Rectangle);
        ...
        describe('#getBBox', () => {
            it('should return a rectangle instance', () => {
                ...
                expect(createVector(svgCircle).getBBox({})).toBeInstanceOf(Rectangle);
                expect(createVector(svgLinearGradient).getBBox()).toBeInstanceOf(Rectangle);
                expect(createVector(svgCircle).getBBox({ recursive: true })).toBeInstanceOf(Rectangle);
                expect(createVector(svgGroup).getBBox({ recursive: true })).toBeInstanceOf(Rectangle);
                expect(createVector(svgGroup).getBBox({ target: svgContainer })).toBeInstanceOf(Rectangle);
                expect(createVector(svgGroup).getBBox({ target: svgCircle })).toBeInstanceOf(Rectangle);
                expect(createVector(svgGroup1).getBBox({ recursive: true })).toBeInstanceOf(Rectangle);
                expect(createVector(svgGroup1).getBBox({ target: svgContainer })).toBeInstanceOf(Rectangle);
                expect(createVector(svgGroup1).getBBox({ target: svgCircle })).toBeInstanceOf(Rectangle);
                expect(createVector(svgLinearGradient).getBBox({ recursive: true })).toBeInstanceOf(Rectangle);
                expect(createVector(svgLinearGradient).getBBox({
                    target: svgContainer,
                })).toBeInstanceOf(Rectangle);
                expect(createVector(svgLinearGradient).getBBox({ target: svgCircle })).toBeInstanceOf(Rectangle);
                expect(getBBox(foreignDiv)).toBeInstanceOf(Rectangle);
            });
        });
