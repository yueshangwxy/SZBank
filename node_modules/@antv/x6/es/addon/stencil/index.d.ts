...
export declare class Stencil extends View {
    ...
    protected filter(keyworld: string, filter?: Stencil.Filter): void;
    protected isCellMatched(cell: Cell, keyworld: string, filters: Stencil.Filters | undefined, ignoreCase: boolean): boolean;
...
export declare namespace Stencil {
    ...
    type FilterFn = (this: Stencil, cell: Node, keyworld: string, groupName: string | null, stencil: Stencil) => boolean;
    interface Group {
        name: string;
        title?: string;
        collapsed?: boolean;
