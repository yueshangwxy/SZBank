...
export class Scroller extends View {
    ...
    update() {
        ...
        const options = Object.assign({ gridWidth: this.options.pageWidth, gridHeight: this.options.pageHeight, allowNewOrigin: 'negative' }, fitTocontentOptions);
    ...
    zoomToRect(rect, options = {}) {
        ...
        if (options.viewportArea == null) {
            options.viewportArea = Object.assign(Object.assign({}, origin), { width: this.$container.width(), height: this.$container.height() });
        }
        this.beforeManipulation();
...
(function (Util) {
    ...
    function getOptions(options) {
        const merged = ObjectExt.merge({}, Util.defaultOptions, options);
