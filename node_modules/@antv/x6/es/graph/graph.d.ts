...
export declare class Graph extends Basecoat<EventArgs> {
    ...
    drawBackground(options?: Background.Options): this;
    ...
    zoomTo(factor: number, options?: Omit<ScrollerWidget.ZoomOptions, 'absolute'>): void;
...
export declare namespace Graph {
    const registerNode: {
        (entities: {
            [name: string]: typeof Node | (Node.Config & {
                inherit?: string | typeof Node | undefined;
            });
        }, force?: boolean | undefined): void;
        <K extends string | number | symbol>(name: K, entity: never[K], force?: boolean | undefined): typeof Node;
        (name: string, entity: typeof Node | (Node.Config & {
            inherit?: string | typeof Node | undefined;
        }), force?: boolean | undefined): typeof Node;
    };
    const registerEdge: {
        (entities: {
            [name: string]: typeof Edge | (Edge.Config & {
                inherit?: string | undefined;
            });
        }, force?: boolean | undefined): void;
        <K extends string | number | symbol>(name: K, entity: never[K], force?: boolean | undefined): typeof Edge;
        (name: string, entity: typeof Edge | (Edge.Config & {
            inherit?: string | undefined;
        }), force?: boolean | undefined): typeof Edge;
    };
    const registerView: {
        (entities: {
            [name: string]: new (...args: any[]) => CellView<Cell<Cell.Properties>, CellView.Options>;
        }, force?: boolean | undefined): void;
        <K extends string | number>(name: K, entity: KeyValue<new (...args: any[]) => CellView<Cell<Cell.Properties>, CellView.Options>>[K], force?: boolean | undefined): new (...args: any[]) => CellView<Cell<Cell.Properties>, CellView.Options>;
        (name: string, entity: new (...args: any[]) => CellView<Cell<Cell.Properties>, CellView.Options>, force?: boolean | undefined): new (...args: any[]) => CellView<Cell<Cell.Properties>, CellView.Options>;
    };
    const registerAttr: {
        (entities: {
    ...
    const registerFilter: {
        (entities: {
            [name: string]: Registry.Filter.Definition<KeyValue<any>>;
        }, force?: boolean | undefined): void;
        <K extends "blur" | "highlight" | "outline" | "dropShadow" | "grayScale" | "sepia" | "saturate" | "hueRotate" | "invert" | "brightness" | "contrast">(name: K, entity: typeof import("../registry/filter/main")[K], force?: boolean | undefined): Registry.Filter.Definition<KeyValue<any>>;
        (name: string, entity: Registry.Filter.Definition<KeyValue<any>>, force?: boolean | undefined): Registry.Filter.Definition<KeyValue<any>>;
    };
    const registerNodeTool: {
        (entities: {
            [name: string]: typeof import("..").ToolsView.ToolItem | (new (options: import("..").ToolsView.ToolItem.Options) => import("..").ToolsView.ToolItem<CellView<Cell<Cell.Properties>, CellView.Options>, import("..").ToolsView.ToolItem.Options>) | (import("..").ToolsView.ToolItem.Options & {
                inherit?: string | undefined;
            } & KeyValue<any>);
        }, force?: boolean | undefined): void;
        ...
        (name: string, entity: typeof import("..").ToolsView.ToolItem | (new (options: import("..").ToolsView.ToolItem.Options) => import("..").ToolsView.ToolItem<CellView<Cell<Cell.Properties>, CellView.Options>, import("..").ToolsView.ToolItem.Options>) | (import("..").ToolsView.ToolItem.Options & {
            inherit?: string | undefined;
    ...
    const registerPortLayout: {
        (entities: {
            [name: string]: Registry.PortLayout.Definition<KeyValue<any>>;
        }, force?: boolean | undefined): void;
        <K extends "ellipse" | "line" | "left" | "right" | "top" | "bottom" | "absolute" | "ellipseSpread">(name: K, entity: typeof import("../registry/port-layout/main")[K], force?: boolean | undefined): Registry.PortLayout.Definition<KeyValue<any>>;
        (name: string, entity: Registry.PortLayout.Definition<KeyValue<any>>, force?: boolean | undefined): Registry.PortLayout.Definition<KeyValue<any>>;
    };
    const registerPortLabelLayout: {
        (entities: {
            [name: string]: Registry.PortLabelLayout.Definition<KeyValue<any>>;
        }, force?: boolean | undefined): void;
        <K extends "left" | "right" | "top" | "bottom" | "manual" | "outside" | "outsideOriented" | "inside" | "insideOriented" | "radial" | "radialOriented">(name: K, entity: typeof import("../registry/port-label-layout/main")[K], force?: boolean | undefined): Registry.PortLabelLayout.Definition<KeyValue<any>>;
        (name: string, entity: Registry.PortLabelLayout.Definition<KeyValue<any>>, force?: boolean | undefined): Registry.PortLabelLayout.Definition<KeyValue<any>>;
    };
    ...
    const registerRouter: {
        (entities: {
            [name: string]: Registry.Router.Definition<KeyValue<any>>;
        }, force?: boolean | undefined): void;
        <K extends "normal" | "oneSide" | "orth" | "metro" | "manhattan" | "er">(name: K, entity: typeof import("../registry/router/main")[K], force?: boolean | undefined): Registry.Router.Definition<KeyValue<any>>;
        (name: string, entity: Registry.Router.Definition<KeyValue<any>>, force?: boolean | undefined): Registry.Router.Definition<KeyValue<any>>;
    };
    const registerConnector: {
        (entities: {
            [name: string]: Registry.Connector.Definition<Registry.Connector.BaseOptions>;
        }, force?: boolean | undefined): void;
        <K extends "normal" | "rounded" | "smooth" | "jumpover">(name: K, entity: typeof import("../registry/connector/main")[K], force?: boolean | undefined): Registry.Connector.Definition<Registry.Connector.BaseOptions>;
    ...
    const registerAnchor: {
        (entities: {
            [name: string]: Registry.NodeAnchor.Definition<KeyValue<any>>;
        }, force?: boolean | undefined): void;
        <K extends "left" | "right" | "top" | "bottom" | "orth" | "center" | "topLeft" | "topRight" | "bottomLeft" | "bottomRight" | "nodeCenter" | "midSide">(name: K, entity: typeof import("../registry/node-anchor/main")[K], force?: boolean | undefined): Registry.NodeAnchor.Definition<KeyValue<any>>;
        (name: string, entity: Registry.NodeAnchor.Definition<KeyValue<any>>, force?: boolean | undefined): Registry.NodeAnchor.Definition<KeyValue<any>>;
    };
    const registerEdgeAnchor: {
        (entities: {
            [name: string]: Registry.EdgeAnchor.Definition<KeyValue<any>>;
        }, force?: boolean | undefined): void;
        <K extends "orth" | "closest" | "ratio" | "length">(name: K, entity: typeof import("../registry/edge-anchor/main")[K], force?: boolean | undefined): Registry.EdgeAnchor.Definition<KeyValue<any>>;
        (name: string, entity: Registry.EdgeAnchor.Definition<KeyValue<any>>, force?: boolean | undefined): Registry.EdgeAnchor.Definition<KeyValue<any>>;
    };
    const registerConnectionPoint: {
        (entities: {
            [name: string]: Registry.ConnectionPoint.Definition<KeyValue<any>>;
        }, force?: boolean | undefined): void;
        <K extends "rect" | "bbox" | "boundary" | "anchor">(name: K, entity: typeof import("../registry/connection-point/main")[K], force?: boolean | undefined): Registry.ConnectionPoint.Definition<KeyValue<any>>;
        (name: string, entity: Registry.ConnectionPoint.Definition<KeyValue<any>>, force?: boolean | undefined): Registry.ConnectionPoint.Definition<KeyValue<any>>;
    };
    ...
    const registerHTMLComponent: {
        (entities: {
            [name: string]: HTML.Component;
        }, force?: boolean | undefined): void;
        <K extends string | number>(name: K, entity: KeyValue<HTML.Component>[K], force?: boolean | undefined): HTML.Component;
        (name: string, entity: HTML.Component, force?: boolean | undefined): HTML.Component;
    };
}
export declare namespace Graph {
    const unregisterNode: {
        <K extends string | number | symbol>(name: K): typeof Node | null;
        (name: string): typeof Node | null;
    };
    const unregisterEdge: {
        <K extends string | number | symbol>(name: K): typeof Edge | null;
        (name: string): typeof Edge | null;
    };
    const unregisterView: {
        <K extends string | number>(name: K): (new (...args: any[]) => CellView<Cell<Cell.Properties>, CellView.Options>) | null;
        (name: string): (new (...args: any[]) => CellView<Cell<Cell.Properties>, CellView.Options>) | null;
    };
    const unregisterAttr: {
        <K extends string | number>(name: K): string | Registry.Attr.Qualify | Registry.Attr.SetDefinition | Registry.Attr.OffsetDefinition | Registry.Attr.PositionDefinition | null;
        (name: string): string | Registry.Attr.Qualify | Registry.Attr.SetDefinition | Registry.Attr.OffsetDefinition | Registry.Attr.PositionDefinition | null;
    };
    const unregisterGrid: {
        <K extends "dot" | "fixedDot" | "mesh" | "doubleMesh">(name: K): Registry.Grid.Definition<Registry.Grid.Options> | Registry.Grid.Definition<Registry.Grid.Options>[] | null;
        (name: string): Registry.Grid.Definition<Registry.Grid.Options> | Registry.Grid.Definition<Registry.Grid.Options>[] | null;
    };
    const unregisterFilter: {
        <K extends "blur" | "highlight" | "outline" | "dropShadow" | "grayScale" | "sepia" | "saturate" | "hueRotate" | "invert" | "brightness" | "contrast">(name: K): Registry.Filter.Definition<KeyValue<any>> | null;
        (name: string): Registry.Filter.Definition<KeyValue<any>> | null;
    };
    const unregisterNodeTool: {
        <K extends "button" | "boundary" | "button-remove">(name: K): typeof import("..").ToolsView.ToolItem | (new (options: import("..").ToolsView.ToolItem.Options) => import("..").ToolsView.ToolItem<CellView<Cell<Cell.Properties>, CellView.Options>, import("..").ToolsView.ToolItem.Options>) | null;
        (name: string): typeof import("..").ToolsView.ToolItem | (new (options: import("..").ToolsView.ToolItem.Options) => import("..").ToolsView.ToolItem<CellView<Cell<Cell.Properties>, CellView.Options>, import("..").ToolsView.ToolItem.Options>) | null;
    };
    const unregisterEdgeTool: {
        <K extends "button" | "vertices" | "boundary" | "button-remove" | "segments" | "source-anchor" | "target-anchor" | "source-arrowhead" | "target-arrowhead">(name: K): typeof import("..").ToolsView.ToolItem | (new (options: import("..").ToolsView.ToolItem.Options) => import("..").ToolsView.ToolItem<CellView<Cell<Cell.Properties>, CellView.Options>, import("..").ToolsView.ToolItem.Options>) | null;
        (name: string): typeof import("..").ToolsView.ToolItem | (new (options: import("..").ToolsView.ToolItem.Options) => import("..").ToolsView.ToolItem<CellView<Cell<Cell.Properties>, CellView.Options>, import("..").ToolsView.ToolItem.Options>) | null;
    };
    ...
    const unregisterPortLayout: {
        <K extends "ellipse" | "line" | "left" | "right" | "top" | "bottom" | "absolute" | "ellipseSpread">(name: K): Registry.PortLayout.Definition<KeyValue<any>> | null;
        (name: string): Registry.PortLayout.Definition<KeyValue<any>> | null;
    };
    const unregisterPortLabelLayout: {
        <K extends "left" | "right" | "top" | "bottom" | "manual" | "outside" | "outsideOriented" | "inside" | "insideOriented" | "radial" | "radialOriented">(name: K): Registry.PortLabelLayout.Definition<KeyValue<any>> | null;
        (name: string): Registry.PortLabelLayout.Definition<KeyValue<any>> | null;
    };
    ...
    const unregisterRouter: {
        <K extends "normal" | "oneSide" | "orth" | "metro" | "manhattan" | "er">(name: K): Registry.Router.Definition<KeyValue<any>> | null;
        (name: string): Registry.Router.Definition<KeyValue<any>> | null;
    };
    const unregisterConnector: {
        <K extends "normal" | "rounded" | "smooth" | "jumpover">(name: K): Registry.Connector.Definition<Registry.Connector.BaseOptions> | null;
        (name: string): Registry.Connector.Definition<Registry.Connector.BaseOptions> | null;
    };
    const unregisterAnchor: {
        <K extends "left" | "right" | "top" | "bottom" | "orth" | "center" | "topLeft" | "topRight" | "bottomLeft" | "bottomRight" | "nodeCenter" | "midSide">(name: K): Registry.NodeAnchor.Definition<KeyValue<any>> | null;
        (name: string): Registry.NodeAnchor.Definition<KeyValue<any>> | null;
    };
    const unregisterEdgeAnchor: {
        <K extends "orth" | "closest" | "ratio" | "length">(name: K): Registry.EdgeAnchor.Definition<KeyValue<any>> | null;
        (name: string): Registry.EdgeAnchor.Definition<KeyValue<any>> | null;
    };
    const unregisterConnectionPoint: {
        <K extends "rect" | "bbox" | "boundary" | "anchor">(name: K): Registry.ConnectionPoint.Definition<KeyValue<any>> | null;
        (name: string): Registry.ConnectionPoint.Definition<KeyValue<any>> | null;
    };
    ...
    const unregisterHTMLComponent: {
        <K extends string | number>(name: K): string | HTMLElement | ((this: Graph, node: HTML<HTML.Properties>) => string | HTMLElement) | null;
        (name: string): string | HTMLElement | ((this: Graph, node: HTML<HTML.Properties>) => string | HTMLElement) | null;
    };
}
