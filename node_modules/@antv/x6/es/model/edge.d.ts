...
export declare class Edge<Properties extends Edge.Properties = Edge.Properties> extends Cell<Properties> {
    ...
    getFragmentAncestor(): Cell<Cell.Properties> | null;
...
export declare namespace Edge {
    const registry: Registry<typeof Edge, never, Config & {
...
export declare namespace Edge {
    type Definition = typeof Edge;
    function define(config: Config): typeof Edge;
    function create(options: Metadata): Edge<Properties>;
}
