...
export declare namespace Node {
    const registry: Registry<typeof Node, never, Config & {
...
export declare namespace Node {
    type Definition = typeof Node;
    function define(config: Config): typeof Node;
    function create(options: Metadata): Node<Properties>;
}
