    ...
    Node.prototype.removePorts = function (portsForRemoval, opt) {
        ...
        if (Array.isArray(portsForRemoval)) {
            ...
            if (portsForRemoval.length) {
                options.rewrite = true;
                var currentPorts = __spreadArrays(this.ports.items);
...
(function (Node) {
    ...
    function define(config) {
        ...
        var shape = util_1.ObjectExt.createClass(getClassName(constructorName || others.shape), this);
        shape.config(others);
        if (others.shape) {
