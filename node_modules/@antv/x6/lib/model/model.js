...
var Model = /** @class */ (function (_super) {
    ...
    Model.prototype.clear = function (options) {
        ...
        this.batchUpdate('clear', function () {
            ...
            var cells = raw.sort(function (cell) { return (cell.isEdge() ? 1 : 2); });
    ...
    Model.prototype.addNode = function (metadata, options) {
        if (options === void 0) { options = {}; }
        var node = metadata instanceof node_1.Node ? metadata : this.createNode(metadata);
    ...
    Model.prototype.addEdge = function (metadata, options) {
        if (options === void 0) { options = {}; }
        var edge = metadata instanceof edge_1.Edge ? metadata : this.createEdge(metadata);
