...
export declare class Collection extends Basecoat<Collection.EventArgs> {
    ...
    protected onCellZIndexChanged(args: Cell.EventArgs['change:zIndex']): void;
...
export declare namespace Collection {
    ...
    export interface NodeEventArgs {
        'node:transition:begin': NodeEventCommonArgs & Cell.EventArgs['transition:begin'];
        'node:transition:end': NodeEventCommonArgs & Cell.EventArgs['transition:end'];
    ...
    export interface EdgeEventArgs {
        'edge:transition:begin': EdgeEventCommonArgs & Cell.EventArgs['transition:begin'];
        'edge:transition:end': EdgeEventCommonArgs & Cell.EventArgs['transition:end'];
