...
var Cell = /** @class */ (function (_super) {
    ...
    Cell.prototype.postprocess = function (metadata) { };
    ...
    Cell.prototype.setProp = function (key, value, options) {
        if (typeof key === 'string') {
            ...
            this.store.set(util_1.ObjectExt.merge({}, this.getProp(), key), value);
        }
        return this;
    };
    ...
    Cell.prototype.toggleVisible = function (options) {
        if (options === void 0) { options = {}; }
        if (this.isVisible()) {
            this.hide(options);
        }
    ...
    Cell.prototype.getChildren = function () {
        ...
        return children ? __spreadArrays(children) : null;
    };
    ...
    Cell.prototype.getCommonAncestor = function () {
        ...
        return Cell.getCommonAncestor.apply(Cell, __spreadArrays([this], cells));
    };
    ...
    Cell.prototype.stopTransition = function (path, delim) {
        if (delim === void 0) { delim = '/'; }
    ...
    Cell.prototype.scale = function (sx, sy, origin, options) {
        return this;
    };
    // #endregion
    // #region tools
    Cell.prototype.addTools = function (items, name, options) {
        ...
        if (options.reset) {
            ...
            if (tools == null || name == null || tools.name === name) {
                ...
                tools.name = name;
                tools.items = __spreadArrays(tools.items, toolItems);
...
(function (Cell) {
    ...
    function deepClone(cell) {
        var cells = __spreadArrays([cell], cell.getDescendants({ deep: true }));
