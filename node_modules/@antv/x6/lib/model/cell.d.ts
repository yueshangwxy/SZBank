...
export declare class Cell<Properties extends Cell.Properties = Cell.Properties> extends Basecoat<Cell.EventArgs> {
    ...
    transition<K extends keyof Properties>(path: K, target: Properties[K], options?: Animation.Options, delim?: string): number;
    transition<T extends string | number | KeyValue>(path: string | string[], target: T, options?: Animation.Options, delim?: string): number;
    stopTransition(path: string | string[], delim?: string): this;
    getTransitions(): string[];
    translate(tx: number, ty: number, options?: Cell.TranslateOptions): this;
    scale(sx: number, sy: number, origin?: Point | Point.PointLike, options?: Node.SetOptions): this;
