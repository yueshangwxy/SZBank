...
export declare class CellView<Entity extends Cell = Cell, Options extends CellView.Options = CellView.Options> extends View<CellView.EventArgs> {
    ...
    protected getConstructor<T extends typeof CellView>(): T;
...
export declare namespace CellView {
    function priority(value: number): (ctor: typeof CellView) => void;
    function bootstrap(actions: FlagManager.Actions): (ctor: typeof CellView) => void;
}
export declare namespace CellView {
    const registry: Registry<new (...args: any[]) => CellView, KeyValue<new (...args: any[]) => CellView>, never>;
}
