...
var CellView = /** @class */ (function (_super) {
    ...
    CellView.getOptions = function (options) {
        var mergeActions = function (arr1, arr2) {
            if (arr2 != null) {
                return util_1.ArrayExt.uniq(__spreadArrays((Array.isArray(arr1) ? arr1 : [arr1]), (Array.isArray(arr2) ? arr2 : [arr2])));
            }
            return Array.isArray(arr1) ? __spreadArrays(arr1) : [arr1];
        };
    ...
    CellView.prototype.can = function (feature) {
        ...
        interacting =
            typeof interacting === 'function'
                ? util_1.FunctionExt.call(interacting, this.graph, this)
                : interacting;
    ...
    CellView.prototype.setInteracting = function (interacting) {
    ...
    CellView.prototype.addTools = function (config) {
        this.removeTools();
        if (config) {
            var tools = config instanceof tool_1.ToolsView ? config : new tool_1.ToolsView(config);
            this.tools = tools;
