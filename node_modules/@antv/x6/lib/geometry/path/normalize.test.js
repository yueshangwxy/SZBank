...
describe('v', function () {
    describe('#normalizePathData', function () {
        ...
        it('should parsed by Path', function () {
            ...
            var reconstructedPath1 = path_1.Path.parse(normalizedPath1).serialize();
            ...
            var reconstructedPath2 = path_1.Path.parse(normalizedPath2).serialize();
            ...
            var reconstructedPath3 = path_1.Path.parse(normalizedPath3).serialize();
