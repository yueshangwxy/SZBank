...
var CurveTo = /** @class */ (function (_super) {
    ...
    function CurveTo(arg0, arg1, arg2, arg3, arg4, arg5) {
        ...
        if (arg0 instanceof curve_1.Curve) {
            ...
            _this.controlPoint1 = new point_1.Point(arg0, arg1);
            _this.controlPoint2 = new point_1.Point(arg2, arg3);
            _this.endPoint = new point_1.Point(arg4, arg5);
        }
        else {
            _this.controlPoint1 = point_1.Point.create(arg0);
            _this.controlPoint2 = point_1.Point.create(arg1);
            _this.endPoint = point_1.Point.create(arg2);
        }
        return _this;
    }
    Object.defineProperty(CurveTo.prototype, "end", {
        get: function () {
