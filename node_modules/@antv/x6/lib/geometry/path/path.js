...
var Path = /** @class */ (function (_super) {
    ...
    function Path(args) {
        ...
        if (Array.isArray(args)) {
            if (args[0] instanceof line_1.Line || args[0] instanceof curve_1.Curve) {
                ...
                arr.forEach(function (o, i) {
                    ...
                    if (o instanceof line_1.Line) {
                        _this.appendSegment(Path.createSegment('L', o.end));
                    }
                    else if (o instanceof curve_1.Curve) {
