...
(function (Options) {
    function get(options) {
        var grid = options.grid, selecting = options.selecting, embedding = options.embedding, snapline = options.snapline, resizing = options.resizing, rotating = options.rotating, clipboard = options.clipboard, history = options.history, scroller = options.scroller, minimap = options.minimap, keyboard = options.keyboard, mousewheel = options.mousewheel, others = __rest(options
        // size
        // ----
        , ["grid", "selecting", "embedding", "snapline", "resizing", "rotating", "clipboard", "history", "scroller", "minimap", "keyboard", "mousewheel"]);
        // size
        // ----
    ...
    Options.defaults = {
        ...
        connecting: {
            ...
            validateConnection: function (_a) {
                ...
                return view instanceof view_1.NodeView;
            },
            createEdge: function () {
