...
var GraphView = /** @class */ (function (_super) {
    ...
    function GraphView(graph) {
        ...
        var cloned = _this.options.container.cloneNode(true);
        _this.restore = function () {
            var parentNode = _this.container.parentNode;
            if (parentNode) {
                parentNode.replaceChild(cloned, _this.container);
            }
            _this.restore = function () { };
        };
    ...
    GraphView.prototype.guard = function (e, view) {
        ...
        if (view && view.cell && view.cell instanceof model_1.Cell) {
            return false;
        }
...
(function (GraphView) {
    ...
    GraphView.events = (_a = {
        ...
        _a["mousedown   ." + prefixCls + "-edge .label"] = 'onLabelMouseDown',
        _a["touchstart  ." + prefixCls + "-edge .label"] = 'onLabelMouseDown',
        _a);
