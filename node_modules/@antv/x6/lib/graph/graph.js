...
var Graph = /** @class */ (function (_super) {
    ...
    Graph.prototype.setup = function () {
        var _this = this;
        this.model.on('sorted', function () { return _this.trigger('model:sorted'); });
        this.model.on('reseted', function (args) { return _this.trigger('model:reseted', args); });
        this.model.on('updated', function (args) { return _this.trigger('model:updated', args); });
    };
    // #region model
    ...
    Graph.prototype.batchUpdate = function (name, execute, data) {
    ...
    Graph.prototype.drawBackground = function (options) {
        this.background.draw(options);
        return this;
    };
    Graph.prototype.clearBackground = function () {
    ...
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "centerPoint", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "centerContent", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "centerCell", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "positionContent", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "positionCell", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "positionRect", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "positionPoint", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "zoom", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "zoomTo", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "zoomToRect", null);
    __decorate([
        decorator_1.Decorator.checkScroller()
    ], Graph.prototype, "zoomToFit", null);
    __decorate([
