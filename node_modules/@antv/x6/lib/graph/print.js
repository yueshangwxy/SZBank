...
var PrintManager = /** @class */ (function (_super) {
    ...
    PrintManager.prototype.showPrintWindow = function ($pages, options) {
        var _this = this;
        if ($pages) {
            var $body_1 = util_1.$(document.body);
            var $container_1 = util_1.$(this.view.container);
            ...
            var cb_1 = function () {
                if (!ret_1) {
                    ...
                    util_1.$("#" + _this.styleSheetId).remove();
                    _this.graph.trigger('after:print', options);
                    util_1.$(window).off('afterprint', cb_1);
                }
            };
            util_1.$(window).one('afterprint', cb_1);
            setTimeout(cb_1, 200);
            window.print();
        }
    };
    PrintManager.prototype.createPrintPage = function (pageArea, options) {
        ...
        var $page = util_1.$('<div/>').addClass(this.className);
        var $wrap = util_1.$('<div/>')
        ...
        var vSVG = util_1.Dom.createVector(this.view.svg).clone();
    ...
    PrintManager.prototype.updatePrintStyle = function (size, options) {
        ...
        if ($style.length) {
            ...
            util_1.$('head').append("'<style type=\"text/css\" id=\"" + id + "\">" + css + "</style>'");
        }
    };
