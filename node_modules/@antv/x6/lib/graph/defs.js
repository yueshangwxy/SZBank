...
var DefsManager = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DefsManager.prototype, "elem", {
        get: function () {
    ...
    DefsManager.prototype.filter = function (options) {
        ...
        if (!this.isDefined(filterId)) {
            ...
            util_1.Dom.createVector(view_1.Markup.sanitize(markup), attrs).appendTo(this.elem);
        }
        return filterId;
    };
    DefsManager.prototype.gradient = function (options) {
        ...
        if (!this.isDefined(id)) {
            ...
            util_1.Dom.createVector(markup, attrs).appendTo(this.elem);
        }
        return id;
    };
    DefsManager.prototype.marker = function (options) {
        var _this = this;
        var id = options.id, tagName = options.tagName, markerUnits = options.markerUnits, children = options.children, attrs = __rest(options, ["id", "tagName", "markerUnits", "children"]);
        var markerId = id;
        if (!markerId) {
        ...
        if (!this.isDefined(markerId)) {
            ...
            var pathMarker = util_1.Dom.createVector('marker', {
                id: markerId,
                orient: 'auto',
                overflow: 'visible',
                ...
                ? children.map(function (_a) {
                    ...
                    return util_1.Dom.createVector("" + tagName || 'path', _this.normalizeAttrs(__assign(__assign({}, attrs), other)));
                })
                : [util_1.Dom.createVector(tagName || 'path', this.normalizeAttrs(attrs))]);
            this.elem.appendChild(pathMarker.node);
        }
        return markerId;
    };
    DefsManager.prototype.normalizeAttrs = function (attrs) {
        var result = {};
        Object.keys(attrs).forEach(function (key) {
            ...
            if (key.indexOf(':') > 0) {
                ...
                result[util_1.StringExt.kebabCase(key)] = attrs[key];
            }
        });
        return result;
    };
