...
export declare class Hook extends Base implements Hook.IHook {
    ...
    protected allowMultiEdges(edge: Edge): boolean;
    protected allowDanglingEdge(edge: Edge): boolean;
    validateEdge(edge: Edge, type: Edge.TerminalType, initialTerminal: Edge.TerminalData): boolean;
    validateMagnet(cellView: CellView, magnet: Element, e: JQuery.MouseDownEvent): boolean;
    getDefaultEdge(sourceView: CellView, sourceMagnet: Element): Edge<Edge.Properties>;
    validateConnection(sourceView: CellView | null | undefined, sourceMagnet: Element | null | undefined, targetView: CellView | null | undefined, targetMagnet: Element | null | undefined, terminalType: Edge.TerminalType, edgeView?: EdgeView): boolean;
