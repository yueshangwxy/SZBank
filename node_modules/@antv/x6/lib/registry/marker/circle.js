...
exports.circlePlus = function (_a) {
    var r = _a.r, attrs = __rest(_a, ["r"]);
    var radius = r || 5;
    ...
    return {
        children: [
            __assign(__assign({}, exports.circle({ r: radius })), { fill: 'none' }),
            __assign(__assign({}, attrs), { type: 'path', d: util_1.normalize(path.serialize(), -radius) }),
        ],
    };
};
