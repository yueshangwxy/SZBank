...
function createMarker(key, marker, view, attrs, manual) {
    var _a;
    ...
    var options = __assign(__assign(__assign({}, normalizeAttr(attrs)), manual), preset);
    return _a = {},
        _a[key] = "url(#" + view.graph.defineMarker(options) + ")",
        _a;
}
