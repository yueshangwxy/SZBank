...
exports.text = {
    ...
    set: function (text, _a) {
        ...
        var textAttrs = util_1.ObjectExt.pick(attrs, 'lineHeight', 'annotations', 'textPath', 'x', 'textVerticalAnchor', 'eol', 'displayEmpty', 'fontSize');
        ...
        if (cache == null || cache !== textHash) {
            ...
            var textPath_1 = textAttrs.textPath;
            if (textPath_1 != null && typeof textPath_1 === 'object') {
                ...
                if (typeof selector === 'string') {
                    ...
                    if (pathNode instanceof SVGPathElement) {
                        ...
                        textAttrs.textPath = __assign({ 'xlink:href': "#" + pathNode.id }, textPath_1);
                    }
                }
            }
            util_1.Dom.text(elem, "" + text, textAttrs);
