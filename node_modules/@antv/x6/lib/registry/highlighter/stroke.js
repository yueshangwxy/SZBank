...
exports.stroke = {
    highlight: function (cellView, magnet, options) {
        ...
        var magnetVel = util_1.Dom.createVector(magnet);
        var pathData;
        var magnetBBox;
        try {
        ...
        util_1.Dom.attr(path, __assign({ d: pathData, 'pointer-events': 'none', 'vector-effect': 'non-scaling-stroke', fill: 'none' }, options.attrs));
