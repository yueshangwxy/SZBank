...
var Clipboard = /** @class */ (function () {
    ...
    Clipboard.prototype.copy = function (cells, graph, options) {
        ...
        var model = graph instanceof model_1.Model ? graph : graph.model;
    ...
    Clipboard.prototype.cut = function (cells, graph, options) {
        ...
        var model = graph instanceof graph_1.Graph ? graph.model : graph;
    ...
    Clipboard.prototype.paste = function (graph, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        var localOptions = __assign(__assign({}, options), this.options);
