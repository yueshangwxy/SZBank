...
var Handle = /** @class */ (function () {
            ...
            this.$handleContainer.find("." + ClassNames.handle).each(function (_, elem) {
                ...
                if (!handle || !handle.icon) {
                    ...
                    if (contect && 'none' !== contect) {
                        ...
                        if ($icons.length) {
                            util_1.Dom.createVector($icons[0]).text(contect.replace(/['"]/g, ''));
                        }
                    }
                    ...
                    if (bgImg) {
                        ...
                        if (matches) {
                            ...
                            if ($imgs.length > 0) {
                                util_1.Dom.createVector($imgs[0]).attr('xlink:href', href);
                            }
                        }
                    }
                }
    ...
    Handle.prototype.renderHandle = function (handle) {
        ...
        if (this.handleOptions.type === 'pie') {
            ...
            var vSvg = util_1.Dom.createVector('svg').addClass(ClassNames.pieSlice + "-svg");
            var vPath = util_1.Dom.createVector('path')
            ...
            var vImg = util_1.Dom.createVector('image')
                .attr(pos)
                .addClass(ClassNames.pieSlice + "-img");
            pos.y = pos.y + iconSize - 2;
            var vText = util_1.Dom.createVector('text', { 'font-size': iconSize })
                .attr(pos)
