...
var Selection = /** @class */ (function (_super) {
    ...
    Selection.prototype.onTransformed = function () {
    ...
    Selection.prototype.stopSelecting = function (evt) {
        ...
        switch (action) {
            case 'selecting': {
                ...
                var cells = this.getNodesInArea(rect).map(function (view) { return view.cell; });
                this.reset(cells);
                break;
            }
            case 'translating': {
    ...
    Selection.prototype.getNodesInArea = function (rect) {
        var graph = this.graph;
        var options = {
    ...
    Selection.prototype.doResize = function (_a) {
        ...
        if (0.001 < Math.abs(width - newWidth) ||
