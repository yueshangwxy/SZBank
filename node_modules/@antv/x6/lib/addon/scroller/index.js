...
var Scroller = /** @class */ (function (_super) {
    ...
    Scroller.prototype.updatePageBreak = function () {
        ...
        if (options.pageVisible && options.pageBreak) {
            ...
            if (graphWidth > pageWidth || graphHeight > pageHeight) {
                ...
                util_1.Dom.addClass(this.pageBreak, this.prefixClassName('graph-pagebreak'));
    ...
    Scroller.prototype.update = function () {
        ...
        if (typeof fitTocontentOptions === 'function') {
            fitTocontentOptions = util_1.FunctionExt.call(fitTocontentOptions, this, this);
        }
        var options = __assign({ gridWidth: this.options.pageWidth, gridHeight: this.options.pageHeight, allowNewOrigin: 'negative' }, fitTocontentOptions);
    ...
    Scroller.prototype.zoomToRect = function (rect, options) {
        ...
        var graph = this.graph;
        var origin = { x: graph.options.x, y: graph.options.y };
        options.contentArea = area;
        if (options.viewportArea == null) {
            options.viewportArea = __assign(__assign({}, origin), { width: this.$container.width(), height: this.$container.height() });
        }
        this.beforeManipulation();
    ...
    Scroller.prototype.getPadding = function () {
        ...
        if (typeof padding === 'function') {
            return util_1.NumberExt.normalizeSides(util_1.FunctionExt.call(padding, this));
        }
    ...
    Scroller.prototype.setCursor = function (value, options) {
        if (options === void 0) { options = {}; }
...
(function (Util) {
    ...
    function getOptions(options) {
        var merged = util_1.ObjectExt.merge({}, Util.defaultOptions, options);
