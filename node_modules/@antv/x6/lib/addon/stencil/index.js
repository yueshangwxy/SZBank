...
var Stencil = /** @class */ (function (_super) {
    ...
    function Stencil(options) {
        ...
        _this.$container = _this.$(_this.container).addClass(_this.prefixClassName(ClassNames.base));
    ...
    Object.defineProperty(Stencil.prototype, "targetScroller", {
        get: function () {
            ...
            return target instanceof graph_1.Graph ? target.scroller.widget : target;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Stencil.prototype, "targetGraph", {
        get: function () {
            var target = this.options.target;
            return target instanceof graph_1.Graph ? target : target.graph;
        },
        enumerable: false,
        configurable: true
    });
    ...
    Stencil.prototype.loadGroup = function (cells, groupName) {
        ...
        if (model) {
            var nodes = cells.map(function (cell) {
                return cell instanceof node_1.Node ? cell : node_1.Node.create(cell);
            });
    ...
    Stencil.prototype.filter = function (keyworld, filter) {
        var _this = this;
        var found = Object.keys(this.graphs).reduce(function (memo, groupName) {
            ...
            var items = graph.model.getNodes().filter(function (cell) {
                ...
                if (typeof filter === 'function') {
                    matched = util_1.FunctionExt.call(filter, _this, cell, keyworld, name, _this);
                }
                else if (typeof filter === 'boolean') {
                    matched = filter;
                }
                else {
                    matched = _this.isCellMatched(cell, keyworld, filter, keyworld.toLowerCase() !== keyworld);
                }
    ...
    Stencil.prototype.isCellMatched = function (cell, keyworld, filters, ignoreCase) {
        if (keyworld && filters) {
...
(function (Stencil) {
    Stencil.defaultOptions = __assign({ stencilGraphWidth: 200, stencilGraphHeight: 800, title: 'Stencil', collapsable: false, layout: function (model, group) {
            var options = {
