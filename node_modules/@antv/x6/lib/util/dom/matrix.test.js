...
describe('Dom', function () {
    describe('matrix', function () {
        ...
        var svgContainer = vector_1.createVector('svg').node;
        ...
        describe('#transformPoint', function () {
            var p = { x: 1, y: 2 };
            var group = vector_1.createVector('g');
            var node = group.node;
        ...
        describe('#getTransformToElement', function () {
            it('rotate', function () {
                ...
                var group = vector_1.createVector('g');
                var rect = vector_1.createVector('rect');
        ...
        describe('#transformStringToMatrix', function () {
            var svgTestGroup;
            beforeEach(function () {
                svgTestGroup = vector_1.createVector('g');
