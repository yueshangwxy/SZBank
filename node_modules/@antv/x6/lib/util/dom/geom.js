...
exports.getBoundingOffsetRect = exports.animateAlongPath = exports.getIntersection = exports.toGeometryShape = exports.toLocalPoint = exports.getTransformToElement = exports.getBBox = exports.bbox = void 0;
...
function toGeometryShape(elem) {
    ...
    switch (elem instanceof SVGElement && elem.nodeName.toLowerCase()) {
        ...
        case 'path': {
            ...
            if (!geometry_1.Path.isSupported(d)) {
 ...
 */
function animateAlongPath(elem, attrs, path) {
