...
<!--            <div style="text-align: center">
            ...
            <ul class="user-info">
              ...
              <li><svg-icon icon-class="dept" /> 所属部门 <div class="user-right"> {{ user.dept }}</div></li>
              <li><svg-icon icon-class="role" /> 用户角色 <div class="user-right"> {{ user.roles.map(e=>e.name).join(",") }}</div></li>
<!--              <li>
      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="18" :xl="19">
        <!--    用户资料    -->
        <el-card class="box-card" style="min-height: 358px">
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="用户资料" name="first">
              <el-form ref="form" :model="form" :rules="rules" disabled style="margin-top: 10px;" size="small" label-width="65px">
...
<!--                <el-form-item label="">
            ...
            <el-tab-pane label="操作日志" name="second">
              <el-table v-loading="loading" :data="data" style="width: 100%;">
                ...
                <el-table-column prop="requestIp" label="IP"  width="120px"/>
                <!-- <el-table-column :show-overflow-tooltip="true" prop="address" label="IP来源" /> -->
                <el-table-column prop="browser" label="浏览器" width="120px"/>
                <el-table-column prop="time" label="请求耗时" align="center" width="120px">
