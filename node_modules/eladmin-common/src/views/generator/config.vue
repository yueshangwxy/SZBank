          ...
          <el-form size="small" label-width="90px">
            <el-table v-loading="loading" :data="data" :max-height="tableHeight" size="small"
              ...
              <el-table-column label="表单类型">
                <template slot-scope="scope">
                  <el-select v-model="data[scope.$index].formType" filterable class="edit-input" clearable
                             placeholder="请选择">
                    <el-option
                      label="文本框"
                      value="Input"
              ...
              <el-table-column label="查询方式">
                <template slot-scope="scope">
                  <el-select v-model="data[scope.$index].queryType" filterable class="edit-input" clearable
                             placeholder="请选择">
                    <el-option
                      label="="
                      value="="
              ...
              <el-table-column label="关联字典">
                <template slot-scope="scope">
                  <el-select v-model="data[scope.$index].dictName" filterable class="edit-input" clearable
                             placeholder="请选择">
      ...
      <el-col>
        <el-card class="box-card" shadow="never">
          ...
          <el-form ref="form" :model="form" :rules="rules" size="small" label-width="78px">
            ...
            <el-form-item label="备注" prop="apiAlias">
              <el-input v-model="form.remark" style="width: 40%"/>
              <span style="color: #C0C0C0;margin-left: 10px;">接口的描述，默认表描述</span>
            </el-form-item>
