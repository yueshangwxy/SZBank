  ...
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;"
      ...
      <el-table-column label="操作" width="160px" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button style="margin-right: 2px" type="text">
            <router-link :to="'/generator/preview?tableName='+scope.row.tableName">
              预览
            </router-link>
          </el-button>
          <el-button style="margin-left: -1px;margin-right: 2px" type="text" @click="toDownload(scope.row.tableName)">
            下载
          </el-button>
          <el-button style="margin-left: -1px;margin-right: 2px" type="text">
            <router-link :to="'/generator/config?tableName='+scope.row.tableName">
              编辑
            </router-link>
          </el-button>
          <el-button type="text" style="margin-left: -1px" @click="toGen(scope.row.tableName)">生成</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!--分页组件-->
