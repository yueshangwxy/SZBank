  ...
  export default {
    ...
    data() {
      return {
        currentTheme: '',
        data: config,
        cstyle: () => require(`@/layout/${this.getTheme()['layout']}/styles/${this.getTheme()['style']}`)
      }
    },
    components: {},
    computed: {
    ...
    /* watch: {
       currentStyle(newValue, oldValue) {
         console.log('watch theme', newValue)
         //return require('../layout/' + this.getTheme()['layout'] + '/styles/' + this.getTheme()['style'])
       }
     }*/
  }
</script>
