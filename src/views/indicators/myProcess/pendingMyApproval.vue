            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" @click="approve(scope.row)" style="color:#409EFE;">通过</el-button>
                        <el-button type="text" @click="reject(scope.row)" style="color:#F56C6C;">拒绝</el-button>
