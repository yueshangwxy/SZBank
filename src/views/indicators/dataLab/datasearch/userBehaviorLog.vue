  ...
  <div class="userBehaviorLog">
      ...
      <div style="overflow-y: auto;overflow-x:hidden;height:100%;padding-left:10px;padding-right:10px">
        <el-form
          ...
          <el-form-item label="用户行为" >
            <el-input type="textarea" v-model="detailForm.content" disabled :rows="5"></el-input>
          </el-form-item>
          <el-form-item label="操作对象" >
            <el-input v-model="detailForm.opObj" disabled></el-input>
          </el-form-item>
          <el-form-item label="所在部门" >
            <el-input v-model="detailForm.opDept" disabled></el-input>
          </el-form-item>
          <el-form-item label="操作人" >
            <el-input v-model="detailForm.opUser" disabled></el-input>
          </el-form-item>
          <el-form-item label="申请时间" >
            <el-date-picker type="datetime" v-model="detailForm.opTime" disabled ></el-date-picker>
          </el-form-item>
          <el-form-item>
    ...
    <div class="condition">
      <el-form :inline="true" :model="queryForm" label-position="left" label-width="80px" >
            ...
            <el-form-item label="行为内容" >
              <el-input
                  placeholder="请输入行为内容关键字"
...
export default {
  ...
  methods:{
    ...
    resetQueryForm() {
      ...
      this.queryForm.opUser = ''
      this.queryForm.opTime = ''
      this.queryPageList()
    },
    async queryPageList() {
      this.queryForm.loading = true
      let res = await request({
        url: '/datalab/userBehaviorLogs/list',
        method: 'post',
        data: {
